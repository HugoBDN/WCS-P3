...
export default function SideBarSousProduct({ setProductByCategory, id }) {
  ...
  function handleToggle() {
    fetch(`${baseUrl}/api/product-cat/${id}`)
      ...
      .catch((err) => console.error("Error fetching data:", err));
  } // Dependency on ID ensures fetch reruns if ID changes

  return (
    <>
      <section className="md:flex w-1/5 hidden flex-col items-center text-2xl font-semibold pt-4 h-[850px]">
        <button
